...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'disconnected_islands_dialog_base.ui'))


class DisconnectedIslandsDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(DisconnectedIslandsDialog, self).__init__(parent)
